...
export class VoiceRecorder {
    ...
    private getFfmpegSpecs(streams: UserStreams, startRecordTime: number, endTimeMs: number, userVolumesDict?: UserVolumesDict): { command: ffmpeg.FfmpegCommand, openServers: Server[] } {
        let ffmpegOptions = ffmpeg();
        const amixStrings: string[] = [];
        const volumeFilter: ffmpeg.FilterSpecification[] = [];
