...
import { getChunkTimeMs, getLastStopTime, secondsToBuffer, syncStream } from './replay-readables.utils.js';
import type { BufferArrayElement, ChunkArrayItem, EncodingOptions, ReadWriteOptions } from './types.js';
...
export class ReplayReadable extends Writable {
    ...
    private readonly fadeOutInterval: NodeJS.Timeout;
    private readonly _encoder: opus.OpusEncoder;
    private readonly encodingOptions: EncodingOptions;
    private _startTimeOfNextChunk?: number | undefined;
    private _startTimeOfChunkBefore?: number | undefined;
    ...
    constructor(lifeTimeMs: number, sampleRate: number, numChannels: number, private getUserSpeakingTime: () => number | undefined, options?: ReadWriteOptions) {
        ...
        this._encoder = new opus.OpusEncoder(sampleRate, numChannels);
